...
func TestEmbeddedSourceVersionIsRelease(t *testing.T) {
	if got := strings.TrimSpace(sourceSemanticVersion); got != "0.0.8" {
		t.Fatalf("expected source VERSION to be 0.0.8, got %q", got)
	}
}

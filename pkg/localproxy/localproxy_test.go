...
func TestSanitizeForwardableRequestHeadersKeepsConnectorAuthorizationBoundary(t *testing.T) {
	input := http.Header{
		...
		"X-OAI-BRTE-Redeemable-Token":    {"internal-redeemable-token"},
		"X-OpenAI-BRTE-Redeemable-Token": {"internal-redeemable-token-alias"},
		"X-OpenAI-Request-Path":          {"/internal/request/path"},
		"True-Client-IP":                 {"203.0.113.11"},
		"X-Client-IP":                    {"203.0.113.12"},
		"X-Cluster-Client-IP":            {"203.0.113.13"},
		"X-Envoy-External-Address":       {"203.0.113.14"},
		"Via":                            {"1.1 proxy.internal"},
		"Forwarded":                      {"for=203.0.113.10"},
		"Connection":                     {"keep-alive, X-Connection-Only", " x-remove-after, Upgrade "},
		"X-Connection-Only":              {"connection-secret"},
		"X-Remove-After":                 {"connection-secret-after"},
		"Keep-Alive":                     {"timeout=5"},
		"OpenAI-Organization":            {"org_internal"},

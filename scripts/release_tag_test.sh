...
"$RELEASE_TAG_SCRIPT" check-source-version v0.0.12
"$RELEASE_TAG_SCRIPT" check-source-version 0.0.12
...
assert_fails_with "source version 0.0.12 in pkg/version/VERSION does not match release version 0.0.13" \

...
"$RELEASE_TAG_SCRIPT" check-source-version 0.0.15
...
assert_fails_with "source version 0.0.15 in pkg/version/VERSION does not match release version 0.0.16" \
  "$RELEASE_TAG_SCRIPT" check-source-version v0.0.16
